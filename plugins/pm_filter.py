        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    ...
                    InlineKeyboardButton('🎬 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 🎬', url='https://t.me/joinchat/axutdh3kmhExZjg1')
                ]
                ]
            await query.message.edit(text=f"<b>💞𝑫𝒆𝒗𝒐𝒍𝒐𝒑𝒆𝒓💞 : <a href='https://t.me/MOVIES_SQUAD_ADMIN'>Alan</a>\n𝑳𝒂𝒏𝒈𝒖𝒂𝒈𝒆 : മലയാളം🤭\n😎𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆😎 :സാധനം പുറത്ത് കൊടുക്കുന്നില്ല കേട്ടോ 😁\n🎬 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 🎬 : <a href='https://t.me/joinchat/ISZ9R5CdkgBlMzNl'>🎬 𝑶𝑻𝑻 𝑼𝒑𝒅𝒂𝒕𝒆𝒔 🎬</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
